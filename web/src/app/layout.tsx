...
import { geist, geistMono, notoSansSC, notoSansTC, orbitron } from "./fonts";
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${geist.variable} ${geistMono.variable} ${notoSansSC.variable} ${notoSansTC.variable} ${orbitron.variable}`}
    >
