...
export function ChannelsListening() {
  ...
  return (
    <div className="flex h-full items-center justify-center bg-canvas px-8">
      ...
      >
        <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-hairline-soft bg-surface-soft">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-ink-deep">{t("channels.listening.activeTitle")}</h3>
          </div>
          <p className="text-xs leading-relaxed text-steel max-w-[22ch] mx-auto">
            {t("channels.listening.activeDescription")}
          </p>
        </div>

        <div className="w-full rounded-lg border border-hairline-soft bg-card p-3.5">
          <div className="flex items-start gap-2.5">
            ...
            <div className="text-left">
              <p className="text-xs font-medium text-ink-deep">{t("channels.listening.openTelegram")}</p>
              <p className="mt-0.5 text-xs text-steel leading-normal">
                {t("channels.listening.openTelegramHintPrefix")}{" "}
                <code className="rounded bg-surface-soft px-1 py-0.5 font-mono text-xs text-ink-deep">hello</code>
              </p>
            </div>
          </div>
        </div>
